...
namespace FiltersAndVMDDemo
{
    public class clsGraphicsDoubleSquare
    {
        ...
        public event dOnDoubleSquareDataChanged OnDoubleSquareGraphicsChanged = null;
        #endregion
        ...
        public void OnMouseMove(float x, float y)
        {
            switch (mState)
            {
                ...
                case eStates.Resizing:
                    OnResize(x, y);
                    if (OnDoubleSquareGraphicsChanged != null)
                    {
                        OnDoubleSquareGraphicsChanged(mDoubleSquareData);
                    }
