...
public:
	...
	//=============================================
	enum eFiltersAndVMDDemoInfoDataTypes : int
	{
		//-------------------------------------
	...
	typedef struct
	{
		...
		int MinimalDistanceBetweenTwoObjects;
		int MaximalAmountOfObjectsToFind;
		eWhatToShowTypes WhatToShowType;
	...
	{
		WindowInfo Windows;
		POINTF DoubleSquare_CenterLocation;
		float DoubleSquare_InnerSquareDiagonal;
		float DoubleSquare_OuterSquareDiagonal;
		BOOL ShowAcceptedObjects;
		BOOL ShowAcceptedObjectsLimitSquares;
	} DrawInfo;
	//---------------------------------------------
	typedef struct
	{
	...
	typedef struct
	{
		...
		FiltersAndVMDDemoInfo* FiltersAndVMDDemoInfo;
	} GDIDrawParams;
};
